							...
							<tr>
								<td colspan="9">
									...
									<div class="panel panel-success">
										...
										<span class="userDetail">회원계정 : <input type="text" value="${user.userId }" size="10px" readonly/></span>
										<span class="userDetail">성명 : <input type="text" value="${user.userName }" size="10px" readonly/></span>
										<span class="userDetail">별명 : <input type="text" value="${user.nickName }" size="10px" readonly/></span><br>
										<span class="userDetail">H.P : <input type="text" value="${user.userPhone }" size="10px" readonly/></span>
										<span class="userDetail">이메일 : <input type="text" value="${user.email }" size="10px" readonly/></span><br>
										<span class="userDetail">주소 : <input type="text" value="(${user.zipCode }) ${user.address }, ${user.detailAddress }" size="45px" readonly/></span>
										<span class="userDetail">은행 : <input type="text" value="${user.bankName }" size="10px" readonly/></span>
										<span class="userDetail">계좌번호 : <input type="text" value="${user.bankAccount }" size="15px" readonly/></span>
										</div>
									</div>
