...
유저 ${authInfo }
	<div class="container">
		...
		<section class="notice_view">
			...
			<a href="<%=request.getContextPath()%>/notice/list?currentPage=${pagination.currentPage }&cntPerPage=${pagination.cntPerPage }&pageSize=${pagination.pageSize }"><button id="go_notice">목록보기</button></a>
