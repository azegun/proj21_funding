	...
	<form action="<%=request.getContextPath() %>/qnaSuccess" method="post">
		<table>
				...
				<tr>
					...
					<td class="td_right"> <input type="text" name="boardTitle" id="boardTitle" required="required"></td>
				</tr>
				<tr>
					<td class="td_left"><label for="boardContent">내용</label></td>
					<td class="td_right"> <textarea name="boardContent" id="boardContent" cols="40" rows="15" required="required"></textarea></td>
				</tr>
		</table>
		<section id="commandCell">
			<input type="submit" value="등록">&nbsp;&nbsp;
			<input type="reset" value="다시쓰기">
			<a href="/board/notice_all"><button id="go_qna">돌아가기</button></a>
		</section>
	</form>
		</section>
		<footer>
